...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    $pet = mysqli_fetch_assoc($r);
    if ($pet) {
        mysqli_query($conn, "DELETE FROM pets WHERE pet_id = $id");
        log_activity($conn, $_SESSION['user_id'], $_SESSION['full_name'], 'superadmin', 'delete_pet', "Deleted pet: {$pet['name']}");
        $success = "Pet '{$pet['name']}' has been deleted.";
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Keep existing image_path if editing and no new file uploaded
...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .pet-actions { display:flex; gap:0.4rem; margin-top:0.6rem; }
        ...
        .btn-del { flex:1; background:#FFEBEE; color:#C62828; border:none; border-radius:8px; padding:0.35rem; font-size:0.78rem; font-weight:700; cursor:pointer; text-decoration:none; text-align:center; transition:all 0.18s; }
...
<div class="main-wrap">
    ...
    <div class="page-sub">Add, edit, or remove pets from the system.</div>
    ...
    <div class="layout">
        ...
        <div class="card-box">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <!-- Age split into years + months to match DB columns age_years / age_months -->
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.7rem" class="mb">
                    <div>
        ...
        <div>
            <form method="GET" class="filter-bar">
                ...
                <a href="manage_pets.php" class="btn-reset">Reset</a>
            </form>

            <?php if (mysqli_num_rows($pets) === 0): ?>
            <div class="card-box"><div class="empty-state"><i class="bi bi-heart"></i>No pets found.</div></div>
            <?php else: ?>
            <div class="pets-grid">
                ...
                <div class="pet-card">
                    ...
                    <div class="pet-body">
                        ...
                        <div class="pet-actions">
                            <a href="?edit=<?= $pet['pet_id'] ?>" class="btn-edit"><i class="bi bi-pencil"></i> Edit</a>
                            <a href="?delete=<?= $pet['pet_id'] ?>" class="btn-del"
                               onclick="return confirm('Delete <?= htmlspecialchars($pet['name']) ?>?')">
